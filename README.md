...
### Startup syntax errors mentioning `index.ts`
- This project is JavaScript. Start it with `node index.js` (not `node index.ts`).
- If you renamed files to TypeScript, revert to the repo files or add a proper TS build setup first.
